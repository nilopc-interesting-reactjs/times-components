...
// $FlowFixMe(>=0.41.0)
const TextTweak = createReactClass({
  displayName: 'TextTweak',
  propTypes: {
    /**
...
if (Platform.OS === 'android') {
  RCTVirtualText = createReactNativeComponentClass({
    ...
    uiViewClassName: 'RCTVirtualTextTweak',
  });
}

module.exports = TextTweak;
