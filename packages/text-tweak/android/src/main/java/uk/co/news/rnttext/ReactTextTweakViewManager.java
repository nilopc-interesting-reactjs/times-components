 ...
 * whole text subtree.
 */
@ReactModule(name = ReactTextTweakViewManager.REACT_CLASS)
public class ReactTextTweakViewManager extends BaseViewManager<ReactTextView, ReactTextShadowNode> {

  @VisibleForTesting
  public static final String REACT_CLASS = "RCTTextTweak";
